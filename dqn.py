...
# TODO: read what is terminal state of this specific game == when is_end becomes True ?
# TODO: can we know we won or lost episode? because agent getting out of screen is also terminal state
# TODO: what is reward function of this game? it is based on distance of st1 - st0 compared to win position?
